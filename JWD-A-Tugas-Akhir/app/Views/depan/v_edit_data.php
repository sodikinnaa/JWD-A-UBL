    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <div class="container mt-5">
                <form id="formPemesanan" action="/wisata/updateData" method="get" >
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="namaPemesan">Nama Pemesan</label>
                            <input type="text" class="form-control" id="namaPemesan"
                                value="<?= $data_transaksi['nm_pemesan'] ?>" name="">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="noHp">No HP / Telp</label>
                            <input type="text" class="form-control" id="noHp"
                                value="<?= $data_transaksi['tlp_pelanggan'] ?>"
                                name="tlp_pelanggan">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="date" class="form-control" id="tanggalPemesanan"
                                value="<?= $data_transaksi['tgl_pemesanan'] ?>"
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" class="form-control" id="durasiPemesanan"
                                value="<?= $data_transaksi['durasi_pemesanan'] ?>"
                                name="durasiPemesanan">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="jumlahPemesan">Jumlah Pemesan</label>
                            <input type="number" class="form-control" id="jumlahPemesan" value="<?= $data_transaksi['jmlh_pesan'] ?>"
                            name="jumlahPemesan">
                        </div>
                        <!-- output hasil -->
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="idTransansi"
                            name="idTransansi" value="<?= $data_transaksi['id_transaksi']?>"
                             disabled>
                        </div>
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="hargaPaket" name=""
                            name=""
                             disabled>
                        </div>
                        <label for="total_harga">Jumlah Tagihan</label>
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text">RP. </span>
                            </div>
                            <input type="text" class="form-control" id="total_harga" name="total_harga" value="<?= $data_transaksi['total_harga']?>" disabled>
                        </div>
                    </div>
                    <button type="button" class="btn btn-primary" onclick="hitungTotal()">Hitung</button>
                    <button id="nextStep" type="submit" class="btn btn-primary"
